...
const int deletion_bar_for_ss = 3000;
const int deletion_num_for_ss = 600;
const int deletion_bar_for_c2 = 500;
const int deletion_num_for_c2 = 100;
...
int main(int argc, char *argv[]) {
    ...
    int pop_num_for_c2 = 0;
    int pop_num_for_ss = 0;
    while (true) {
        int total = 0;
        for (int i = 0; i < 5; i ++) {
        ...
        if (tmp < recs[1].size()) {
            ...
            ++ pop_num_for_c2;
            if (pop_num_for_c2 >= deletion_bar_for_c2 && pop_num_for_c2 % deletion_bar_for_c2 == 0) {
                fout << "d" << " " << modify(1) << " " << deletion_num_for_c2 << endl;
            }
        } else {
            int sid = 4;
            line = recs[4].back();
            ...
            ++ pop_num_for_ss;
            if (pop_num_for_ss >= deletion_bar_for_ss && pop_num_for_ss % deletion_bar_for_ss == 0) {
                fout << "d" << " " << modify(4) << " " << deletion_num_for_ss << endl;
            }
        }
